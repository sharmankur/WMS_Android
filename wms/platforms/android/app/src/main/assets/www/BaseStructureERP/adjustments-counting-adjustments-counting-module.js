...
var PhysicalCountComponent = /** @class */ (function () {
    ...
    PhysicalCountComponent.prototype.LotExistCheck = function () {
        if (this.ItemTracking == "S") {
            this.showDialog("addBatchSer", this.translate.instant("yes"), this.translate.instant("no"), this.translate.instant("PhyCount_LotvalidSerial"));
            this.CountedQty = "1";
            this.formatCountedQty();
        }
        if (this.ItemTracking == "B") {
            this.showDialog("addBatchSer", this.translate.instant("yes"), this.translate.instant("no"), this.translate.instant("PhyCount_LotvalidBatch"));
        }
    };
    ...
    PhysicalCountComponent.prototype.OnLotChange = function (savenext) {
        var _this = this;
        ...
        if (this.DocNoDetails != null) {
            if (this.DocNoDetails.length > 0) {
                ...
                if (TotalSave == DocDataLength) {
                    this.showDialog("SubmitAll", this.translate.instant("yes"), this.translate.instant("no"), this.translate.instant("PhyCount_SubmitSaveLines"));
                }
                else {
                    this.resetData();
    ...
    PhysicalCountComponent.prototype.SavePhysicalCountData = function (oAddPhysicalCountData) {
        ...
        this.phycountService.SavePhysicalCountData(oAddPhysicalCountData).subscribe(function (data) {
            ...
            if (data != null) {
                if (data == "True") {
                    _this.toastr.success('', _this.translate.instant("PhyCount_DataSavedSuccessfully"));
                    _this.QtyOnHand = "0";
                    _this.CountedQty = "0";
                    _this.formatCountedQty();
                    _this.formatOnHandQty();
                    _this.NextRecord();
                    _this.showitemlist = true;
                }
                else {
                    _this.toastr.success('', _this.translate.instant("PhyCount_NoDataSaved"));
                }
            }
        }, function (error) {
            _this.showLoader = false;
    ...
    PhysicalCountComponent.prototype.onCountedQtyChanged = function () {
        ...
        if (result != undefined) {
            if (this.ItemTracking == "S") {
                this.showDialog("overwrite", this.translate.instant("PhyCount_Overwrite"), "", this.translate.instant("PhyCount_SerialQtyChangeMsg"));
            }
            if (this.ItemTracking == "B") {
                this.showDialog("overwrite", this.translate.instant("PhyCount_Overwrite"), "add", this.translate.instant("PhyCount_BatchQtyChangeMsg"));
            }
        }
        this.formatCountedQty();
    };
    PhysicalCountComponent.prototype.onSaveClick = function (existingItem) {
    ...
    PhysicalCountComponent.prototype.resetData = function () {
        this.batchserno = "";
        this.QtyOnHand = "0";
        this.CountedQty = "0";
    };
